{ pkgs, lib, config, ... }: {
  ...
  home.file.".blerc".text = ''
    ...
    ble-face syntax_quoted='fg=#8f9d6a'
    ble-face syntax_quotation='fg=#8f9d6a'
    ...
    ble-face command_directory='fg=#9b859d,underline'
    ble-face filename_directory='fg=#9b859d,underline'
    ble-face argument_option='fg=#afc4db'
    ble-face region_insert='fg=#9b859d'
    ble-face region_match='bg=153,fg=black,bold'
    ble-face varname_export='fg=#8f9d6a,bold'
  '';
}
